...
execute as @a[x=0] unless score @s bb.deaths matches 0 at @s run function biomebloodshed:start/on_death
...
execute as @e[type=marker,x=0,tag=bb.IslandSpawner,tag=!bb.ToRemove,tag=!bb.Completed,limit=1] at @s run function biomebloodshed:start/generate_island
