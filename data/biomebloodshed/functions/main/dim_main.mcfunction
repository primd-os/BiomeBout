...
execute if score IsReloading bb.Variables matches 0 as @a[x=0,tag=!bb.hasClosePlayer,gamemode=!spectator] at @s if entity @a[distance=0.01..15,gamemode=!spectator] run playsound block.note_block.chime player @s ~ ~ ~ 1 0.5 1
