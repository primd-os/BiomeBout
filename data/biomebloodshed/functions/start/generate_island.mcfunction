scoreboard players set modulo bb.Variables 14
...
execute if score Rand bb.Variables matches 5 run data modify storage biomebloodshed:name name set value "biomebloodshed:islands/swamp"
...
execute if score Rand bb.Variables matches 12 run data modify storage biomebloodshed:name name set value "biomebloodshed:islands/taiga"
execute if score Rand bb.Variables matches 12 positioned ~ ~ ~ run function biomebloodshed:start/place_island

execute if score Rand bb.Variables matches 13 run data modify storage biomebloodshed:name name set value "biomebloodshed:islands/badlands"
execute if score Rand bb.Variables matches 13 positioned ~ ~ ~ run function biomebloodshed:start/place_island
