...
execute as @s[advancements={rx:death_cause/arrow=true},tag=dieMarked] run tellraw @a[x=0] ["", {"selector":"@s"}, " was shot by ", {"selector":"@a[tag=bb.killed,x=0,limit=1]"}, "'s arrow"]
execute as @s[advancements={rx:death_cause/arrow=true},tag=dieMarked] run tag @s add bb.Messaged
execute as @s[advancements={rx:death_cause/explosion=true},tag=dieMarked] run tellraw @a[x=0] ["", {"selector":"@s"}, " was blown up by ", {"selector":"@a[tag=bb.killed,x=0,limit=1]"}]
execute as @s[advancements={rx:death_cause/explosion=true},tag=dieMarked] run tag @s add bb.Messaged
execute as @s[advancements={rx:death_cause/fire=true},tag=dieMarked] run tellraw @a[x=0] ["", {"selector":"@s"}, " was burned to death by ", {"selector":"@a[tag=bb.killed,x=0,limit=1]"}]
execute as @s[advancements={rx:death_cause/fire=true},tag=dieMarked] run tag @s add bb.Messaged
execute as @s[advancements={rx:death_cause/void=true},tag=dieMarked] run tellraw @a[x=0] ["", {"selector":"@s"}, " fell due to ", {"selector":"@a[tag=bb.killed,x=0,limit=1]"}]
execute as @s[advancements={rx:death_cause/void=true},tag=dieMarked] run tag @s add bb.Messaged
execute as @s[advancements={rx:death_cause/melee=true},tag=dieMarked,tag=!bb.Messaged] run tellraw @a[x=0] ["", {"selector":"@s"}, " was stabbed by ", {"selector":"@a[tag=bb.killed,x=0,limit=1]"}]
execute as @s[advancements={rx:death_cause/melee=true},tag=dieMarked] run tag @s add bb.Messaged
execute as @s[advancements={rx:death_cause/magic=true},tag=dieMarked,tag=!bb.Messaged] run tellraw @a[x=0] ["", {"selector":"@s"}, " was magiced by ", {"selector":"@a[tag=bb.killed,x=0,limit=1]"}]
execute as @s[advancements={rx:death_cause/magic=true},tag=dieMarked] run tag @s add bb.Messaged
execute as @s[advancements={rx:death_cause/lightning=true},tag=dieMarked,tag=!bb.Messaged] run tellraw @a[x=0] ["", {"selector":"@s"}, " was struck with lightning by ", {"selector":"@a[tag=bb.killed,x=0,limit=1]"}]
execute as @s[advancements={rx:death_cause/lightning=true},tag=dieMarked] run tag @s add bb.Messaged
execute as @s[advancements={rx:death_cause/starvation=true},tag=dieMarked,tag=!bb.Messaged] run tellraw @a[x=0] ["", {"selector":"@s"}, " was starved by ", {"selector":"@a[tag=bb.killed,x=0,limit=1]"}]
execute as @s[advancements={rx:death_cause/starvation=true},tag=dieMarked] run tag @s add bb.Messaged
