execute unless entity @e[type=marker,tag=bb.IslandSpawner,distance=..40,tag=!bb.ToRemove] positioned 0 ~ 0 unless entity @s[distance=..20] run tag @s remove bb.ToRemove
