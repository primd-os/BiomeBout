...
execute in biomebloodshed:game as @e[type=marker,x=0,tag=bb.IslandSpawner,tag=!bb.ToRemove,tag=!bb.Completed,limit=1] at @s run function biomebloodshed:start/generate_island
